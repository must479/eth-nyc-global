...
exports.version = "17.0.3-experimental-d6604ac03";
...
function renderer_attach(hook, rendererID, renderer, global) {
  ...
  function onErrorOrWarning(fiber, type, args) {
    ...
    var fiberID = getOrGenerateFiberID(fiber);
  ...
  function updateComponentFilters(componentFilters) {
    ...
    unmountAndRemountAllRoots(function () {
      applyComponentFilters(componentFilters);
    });
  }

  function unmountAndRemountAllRoots(callback) {
  ...
  function recordMount(fiber, parentFiber) {
    ...
    if (isRoot) {
      ...
      var ownerID = _debugOwner != null ? getFiberIDThrows(_debugOwner) : 0;
