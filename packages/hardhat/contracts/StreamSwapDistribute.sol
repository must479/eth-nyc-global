...
import {IAggregagationRouterV4} from "./IAggregagationRouterV4.sol";
...
contract StreamSwapDistribute is StreamInDistributeOut {
    ...
    IAggregagationRouterV4 internal immutable _router;
    uint256 private constant _SHOULD_CLAIM_FLAG = 0x04;
    address public immutable override AGGREGATION_ROUTER_V4;
        ...
        returns (uint256 distributionAmount)
    {
        ...
        (
            ...
            IAggregagationRouterV4.SwapDescription memory _swapDescription,
            bytes memory _tradeData
        ) = abi.decode(
                _data[4:],
                (
                    IAggregationExecutor,
                    IAggregagationRouterV4.SwapDescription,
                    bytes
                )
            );
